...
import type { ColumnVisibility, ColumnPreset as SharedColumnPreset } from '@/types/table.types';
import { ALL_COLUMN_KEYS, COLUMN_PRESETS } from '../constants/columns';
...
interface ReconToolbarProps {
  ...
  onApplyPreset: (preset: SharedColumnPreset) => void;
  view: 'table' | 'card';
...
export function ReconToolbar({
  ...
  return (
    <DataToolbar
      ...
      onApplyPreset={(preset) => onApplyPreset(preset as SharedColumnPreset)}
      view={view}
