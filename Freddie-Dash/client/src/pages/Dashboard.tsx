        ...
        <Dialog open={isDialogOpen} onOpenChange={(open) => {
          ...
          <DialogContent className="w-full sm:max-w-2xl max-h-[90vh] flex flex-col p-0 gap-0">
            <DialogHeader className="p-6 pb-2">
              ...
              {/* Fake Asset Indicator */}
              {selectedItem?.isFakeAsset && (
                <div className="mt-2 flex items-center gap-2 px-3 py-2 bg-amber-100 dark:bg-amber-900/30 border border-amber-300 dark:border-amber-700 rounded-md">
                  <AlertTriangle className="w-4 h-4 text-amber-600 dark:text-amber-400" />
                  <span className="text-sm font-medium text-amber-700 dark:text-amber-300">This asset is marked as Fake</span>
                </div>
              )}
            </DialogHeader>
